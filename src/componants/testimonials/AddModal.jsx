...
import { addTestimonialApi } from "../../common/services";
...
function AddModal({ onClose, fetchTestimonials }) {
    ...
    const handleSubmit = async (values, { resetForm }) => {
        ...
        try {
            ...
            const res = await addTestimonialApi(formData);
            if (res.success) {
                fetchTestimonials();
                resetForm();
                setPreview(null);
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 p-2">
            <div className="bg-white rounded-2xl shadow-lg w-full max-w-[500px] max-h-[550px] flex flex-col">
                ...
                <Formik
                    initialValues={{ name: "", country: "", message: "", file: null }}
